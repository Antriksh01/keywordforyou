          ...
          <tr className="border-b-2 border-emerald-200 shadow-2xl">
            ...
            <th className="py-4 px-6 border-r-2 border-r-emerald-200">
              <div className="text-center">
                ...
                <div className="text-lg text-black">₹0.00 / Month</div>
              </div>
            </th>
            <th className="py-4 px-6 ">
              <div className="text-center">
                <div className="text-4xl font-bold text-red-600">Pro</div>
                <div className="text-lg text-black">₹300 / Month</div>
              </div>
            </th>
          </tr>
        </thead>
        ...
        <thead>
          <tr className="border-b-2 border-emerald-200 shadow-2xl">
            ...
            <th className="py-4 px-6 border-r-2 border-r-emerald-200">
              <div className="text-center">
                <div className="text-4xl font-bold text-blue-600">Free</div>
                <div className="text-lg text-black">₹0.00 / Yearly</div>
              </div>
            </th>
            <th className="py-4 px-6 ">
              <div className="text-center">
                <div className="text-4xl font-bold text-red-600">Pro</div>
                <div className="text-lg text-black">₹730 / Yearly</div>
              </div>
            </th>
          </tr>
        </thead>
